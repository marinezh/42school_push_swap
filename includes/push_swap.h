...
/*   Updated: 2025/03/08 00:52:56 by mzhivoto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void first_move(t_stack *stack_a, t_stack *stack_b, int chunks);
...
void				find_min_max(t_stack *stack, int start, int end, int *min,
						int *max);
